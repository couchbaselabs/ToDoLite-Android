                    ...
                    new GraphRequest.GraphJSONObjectCallback() {
                        ...
                        public void onCompleted(JSONObject jsonObject, GraphResponse graphResponse) {
                            ...
                            if (preferences.getCurrentUserId() == null) {
                                ...
                                Toast.makeText(WelcomeActivity.this, "Login successful!  Starting sync.", Toast.LENGTH_LONG).show();
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                try {
                    ...
                    Toast.makeText(WelcomeActivity.this, "Invalid username/pass", Toast.LENGTH_LONG).show();
                }
            }
        });
